...
import { loadPermissions, requirePermission, requireSelfOrPermission } from '#/middleware/permissions.js';
...
router.put('/:id/password', requireSelfOrPermission('id', 'users:update'), h.changePassword);
